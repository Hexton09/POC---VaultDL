                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="text-sm">
                                            ...
                                            <p className="text-amber-700 dark:text-amber-300 leading-relaxed">
                                                Due to YouTube's anti-bot measures, downloads may fail on cloud-hosted platforms. 
                                                For best results, consider running this locally or using VPS hosting with residential IPs.
                                            </p>
                                        </div>
                                    </div>
                                </div>
